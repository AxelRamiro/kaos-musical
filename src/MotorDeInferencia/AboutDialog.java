...
public class AboutDialog extends JDialog {
  ...
  void jbInit() throws Exception {
    ...
    jLabel2.setText("Universidad Autonoma del Estado de Hidalgo");
    jLabel2.setBounds(new Rectangle(2, 27, 398, 38));
    jLabel3.setHorizontalAlignment(SwingConstants.CENTER);
    jLabel3.setText("C. I. T. I. S. ");
    jLabel3.setBounds(new Rectangle(0, 66, 401, 22));
    jLabel4.setHorizontalAlignment(SwingConstants.CENTER);
    jLabel4.setText("Dr. Omar Lopez Ortega");
    jLabel4.setBounds(new Rectangle(2, 106, 400, 26));
    jLabel5.setHorizontalAlignment(SwingConstants.CENTER);
    jLabel5.setText("Israel Villar Medina, 2006");
