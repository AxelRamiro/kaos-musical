...
public class BooleanRuleBase implements RuleBase {
  ...
  public void displayRules(JTextArea textArea) {
    ...
    if (factList != null) {
      enume = factList.elements();
      while (enume.hasMoreElements()) {
        Fact temp = (Fact) enume.nextElement();
  ...
  public void initializeFacts() {
    if (factList != null) {
      Enumeration enume = factList.elements();

      while (enume.hasMoreElements()) {
        Fact fact = (Fact) enume.nextElement();
  ...
  public Vector getGoalVariables() {
    ...
    while (enume.hasMoreElements()) {
      RuleVariable ruleVar = (RuleVariable) enume.nextElement();
