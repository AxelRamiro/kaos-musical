...
public class calculoIndiceValidezCH {
    ...
    public double calculoCentroideGeneral(ArrayList instancias) {
        ...
        try {
            for (int i = 0; i < instancias.size(); i++) {
             ...
             // System.out.println(instancias.get(i).toString()); 
                // System.out.println("Instancias [" + instancias.get(i).toString()+"]");   
                sumaceng = sumaceng + Double.parseDouble((String) instancias.get(i));
            }

            System.out.println("suma de todos las instancias: " + sumaceng);
            cenGeneral = (sumaceng / contador);
            System.out.println("El centroide general es: " + cenGeneral);
        } catch (Exception e) {
            System.out.println("Error en clustering: " + e.getMessage());
        }
    ...
    public double distanciaSeparacionCluster(ArrayList centroide, double cenGeneral, ArrayList totalInstancias) {
        double minimo = 0;
        double sumad = 0;
        double disSC = 0;
        double cen = 0; /// valida si el centroide es igual a NAN
        try {
            for (int i = 0; i < centroide.size(); i++) {
                ...
                if (Double.isNaN(cen) == true) {
                    ...
                    res1 = cenGeneral;
                    resta = Math.abs(res - res1);
                    instancias = Double.parseDouble((String) totalInstancias.get(i));
                    total = resta;
                    multi = total * instancias;
                    sumad = sumad + multi;
                    System.out.println("Cluster [" + i + "]" + "Centroide [" + centroide.get(i).toString() + "]  " + " Distancia Centroide  [" + multi + "]");
                }
    ...
    public double distanciaSeparacionCluster1(ArrayList centroide, double cenGeneral, ArrayList totalInstancias) {
        double minimo = 0;
        double sumad = 0;
        double disSC = 0;
        try {
            for (int i = 0; i < centroide.size(); i++) {
                ...
                double instancias;
                res = Double.parseDouble((String) centroide.get(i));
                System.out.println("Valor de Centroide   " + res);
                res1 = cenGeneral;
                System.out.println("Valor de Centroide General   " + res1);
                resta = Math.abs(res - res1);
                System.out.println("Valor de resta   " + resta);
                instancias = Double.parseDouble((String) totalInstancias.get(i));
                System.out.println("Numero de Instancias   " + instancias);
                total = resta;
                multi = total * instancias;
                sumad = sumad + multi;
                System.out.println("Cluster [" + i + "]" + "Centroide [" + centroide.get(i).toString() + "]  " + " Distancia Centroide  [" + multi + "]");
    ...
    public double distanciaClusterFusionados(String[] referencia, ArrayList noCluster, ArrayList Instancia) {
        String sumaAdagio = "";
        double sumAdagio = 0;
        ...
        try {
            ...
            for (int i = 0; i < referencia.length; i++) {
                if ("ADAGIO".equals(referencia[i])) {
                    ...
                    System.out.println("La suma de distancias es: " + sumAdagio);
                ...
                if ("ADAGGIETO".equals(referencia[i])) {
                    ...
                    System.out.println("La suma de distancias es: " + sumAdaggieto);
                ...
                if ("ANDANTE".equals(referencia[i])) {
                    ...
                    System.out.println("La suma de distancias es: " + sumAndante);
                }
                if ("ANDANTINO".equals(referencia[i])) {
                    ...
                    System.out.println("La suma de distancias es: " + sumAndantino);
                ...
                if ("MODERATO".equals(referencia[i])) {
                    ...
                    System.out.println("La suma de distancias es: " + sumModerato);
                ...
                if ("ALEGRETO".equals(referencia[i])) {
                    ...
                    System.out.println("La suma de distancias es: " + sumAlegreto);
                }
                if ("ALLEGRO".equals(referencia[i])) {
                    ...
                    System.out.println("La suma de distancias es: " + sumAllegro);
                ...
                if ("VIVANCE".equals(referencia[i])) {
                    ...
                    System.out.println("La suma de distancias es: " + sumVivance);
                }
                ...
                if ("PRESTO".equals(referencia[i])) {
                    ...
                    System.out.println("La suma de distancias es: " + sumPresto);
                }
                ...
                if ("PRESSTISIMO".equals(referencia[i])) {
                    ...
                    System.out.println("La suma de distancias es: " + sumPresstisimo);

                }

            }

            /*   System.out.println("Suma de Instancias" + sumAdagio);
             System.out.println("Suma de Instancias" + sumAdaggieto);
             System.out.println("Suma de Instancias" + sumAndante);
             System.out.println("Suma de Instancias" + sumAndantino);
             System.out.println("Suma de Instancias" + sumModerato);
             System.out.println("Suma de Instancias" + sumAlegreto);
             System.out.println("Suma de Instancias" + sumAllegro);
             System.out.println(" Suma de Instancias" + sumVivance);
             System.out.println("Suma de Instancias" + sumPresto);
             System.out.println("Suma de Instancias" + sumPresstisimo);*/
            denominador = sumAdagio + sumAdaggieto + sumAndante + sumAndantino + sumModerato + sumAlegreto + sumAllegro + sumVivance + sumPresto + sumPresstisimo;
    ...
    public double distanciaClusterFusionadosDuracion(String[] referencia, ArrayList noCluster, ArrayList Instancia) {
        String suma1 = "";
        double sum1 = 0;
        String suma12 = "";
        double sum12 = 0;
        ...
        try {
            ...
            /*  System.out.println("Suma de Instancias" + sum1);
             System.out.println("Suma de Instancias" + sum12);
             System.out.println("Suma de Instancias" + sum14);
             System.out.println("Suma de Instancias" + sum18);
             System.out.println("Suma de Instancias" + sum116);*/
            denominador = sum1 + sum12 + sum14 + sum18 + sum116;
    ...
    public double distanciaClusterFusionadosOctava(String[] referencia, ArrayList noCluster, ArrayList Instancia) {
        String sumaC0 = "";
        double sumC0 = 0;
        String sumaC1 = "";
        double sumC1 = 0;
        ...
        try {
            ...
            /*   System.out.println("Suma de Instancias" + sumC0);
             System.out.println("Suma de Instancias" + sumC1);
             System.out.println("Suma de Instancias" + sumC2);
             System.out.println("Suma de Instancias" + sumC3);
             System.out.println("Suma de Instancias" + sumC4);
             System.out.println("Suma de Instancias" + sumC5);
             System.out.println("Suma de Instancias" + sumC6);
             System.out.println("Suma de Instancias" + sumC7);
             System.out.println("Suma de Instancias" + sumC8);
             System.out.println("Suma de Instancias" + sumC9);
             System.out.println("Suma de Instancias" + sumG9);*/
            denominador = sumC0 + sumC1 + sumC2 + sumC3 + sumC4 + sumC5 + sumC6 + sumC7 + sumC8 + sumC9 + sumG9;
